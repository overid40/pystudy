...
#str1[0] = '1'    # 변경 안됨 - 변경 불가 객체 : TypeError
...
print("find()", str1.find("Life", 6)) # 6번 인덱스부터 Life 검색
print("rfind()", str1.rfind("Life")) # 우측으로부터 검색

print("fine() 없는 값:", str1.find("Java"))
# 찾는 내용이 없으면 -1을 반환
